...
5.  **爆文要素**：
    *   **标题**：起两三个标题，要有争议，让人想点进来骂你或者挺你。别用“震惊”、“真相”，太low。
...
6.  **格式**：输出纯文本，段落之间空一行。不要用**加粗**、列表、标题符号这些乱七八糟的。
...
"""
    ...
    def call_deepseek_api(self, prompt, max_tokens=2000):
        ...
        payload = {
            ...
            "messages": [
                {"role": "system",
                 "content": "你是一个有十年经验的爆文编辑，擅长把普通文章改成高传播、高互动的爆款。你说话直接、接地气，文章风格口语化，讨厌AI腔。你会使用大白话、短句，避免使用‘与此同时’之类的连接词。你会刻意制造争议点，吸引读者评论。输出必须纯文本，段落之间空一行，段落数量必须严格控制在用户要求的范围内。"},
